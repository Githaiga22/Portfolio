 ...
 const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div 
        className="min-h-[60vh] md:min-h-screen w-full relative bg-cover bg-center bg-no-repeat" 
        style={{ 
      ...
      >
        ...
        <section className="relative flex flex-col justify-center items-center px-4 py-16 md:py-20 min-h-[60vh] md:min-h-screen w-full">
      ...
      <div className="relative bg-[#0a192f] w-full">
        <Bio />
        <section className="py-20 px-4 bg-[#0a192f]" id="web3-journey">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">My Web3 Journey</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
              I entered the blockchain space in 2024 via the Lisk Bootcamp (in partnership with Web3Clubs Kenya), where I learned Solidity and the fundamentals of decentralized development. In 2025, I was sponsored by Lisk to join the ETH-iopia Builder Residency, where I co-founded IMARA — a hackathon-winning project now evolving into a live startup.
            </p>
            <p className="text-gray-300 leading-relaxed">
              I've since been recognized as a Lisk Pioneer and continue to contribute to growing Web3 adoption across Africa, especially by supporting education and onboarding.
            </p>
          </div>
        </section>
        <Services />
        <section className="py-20 px-4 bg-[#112240] w-full" id="projects">
       ...
       <section className="py-20 px-4 bg-[#0a192f] w-full">
<div className="max-w-6xl w-full mx-auto">
  ...
  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    {skills.map((skill) => (
      ...
      />
        ...
        <section className="py-20 px-4 bg-[#112240] w-full" id="contact">
